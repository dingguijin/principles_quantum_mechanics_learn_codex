...
6. 完成第一轮后，用 [全书总复习路线](docs/review-roadmap.md) 串起主线，再用 [公式索引](docs/formula-index.md) 做快速查漏。
7. 纸质书用于阅读原书推导和习题；本仓库只提供原创讲解、学习路线、补充例题和自测。

## 总复习资料

| 文档 | 用途 |
| --- | --- |
| [全书总复习路线](docs/review-roadmap.md) | 按阶段复盘全书主线、关键问题和自测目标 |
| [公式索引](docs/formula-index.md) | 按主题快速查核心公式和适用场景 |
...
| [第 11 章第 1 讲：什么是对称性，为什么它能压缩物理规律](docs/lessons/11-symmetries/11-01-what-is-symmetry.md) | 对称性、物理规律不变、守恒量预告 |
| [第 11 章第 2 讲：量子态的变换为什么要用幺正算符](docs/lessons/11-symmetries/11-02-unitary-transformations.md) | 幺正变换、内积、概率保持 |
| [第 11 章第 3 讲：连续对称性和生成元](docs/lessons/11-symmetries/11-03-continuous-symmetries-generators.md) | 连续对称、生成元、指数算符 |
| [第 11 章第 4 讲：平移、时间平移和动量能量](docs/lessons/11-symmetries/11-04-translations-momentum-energy.md) | 平移、动量、时间演化、能量 |
| [第 11 章第 5 讲：守恒量、对易关系和后续角动量入口](docs/lessons/11-symmetries/11-05-conservation-commutators-angular-momentum-entry.md) | 守恒量、对易关系、角动量入口 |
| [第 12 章第 1 讲：转动不变性，为什么角动量是转动生成元](docs/lessons/12-rotational-invariance-angular-momentum/12-01-rotations-and-generators.md) | 转动不变性、角动量、生成元 |
| [第 12 章第 2 讲：轨道角动量算符从 r x p 来](docs/lessons/12-rotational-invariance-angular-momentum/12-02-orbital-angular-momentum-operator.md) | 轨道角动量、微分算符、Lz |
| [第 12 章第 3 讲：角动量对易关系和非同时确定性](docs/lessons/12-rotational-invariance-angular-momentum/12-03-angular-momentum-commutators.md) | 角动量代数、对易关系、不确定性 |
...
| [第 14 章第 1 讲：为什么需要自旋，它不是经典小球自转](docs/lessons/14-spin/14-01-why-spin-is-needed.md) | 自旋动机、内禀角动量、经典误解 |
| [第 14 章第 2 讲：自旋 1/2 的二维态空间](docs/lessons/14-spin/14-02-spin-half-state-space.md) | 自旋 1/2、二维态空间、归一化 |
| [第 14 章第 3 讲：Pauli 矩阵和自旋算符](docs/lessons/14-spin/14-03-pauli-matrices-spin-operators.md) | Pauli 矩阵、自旋算符、对易关系 |
...
| [第 17 章第 1 讲：为什么需要定态微扰论](docs/lessons/17-time-independent-perturbation/17-01-why-time-independent-perturbation.md) | 可解模型、小修正、定态问题 |
| [第 17 章第 2 讲：级数展开和 lambda 计阶](docs/lessons/17-time-independent-perturbation/17-02-series-expansion-and-bookkeeping.md) | 哈密顿量展开、能量展开、态展开 |
| [第 17 章第 3 讲：非简并一阶微扰](docs/lessons/17-time-independent-perturbation/17-03-nondegenerate-first-order.md) | 一阶能量修正、一阶态修正 |
...
- 尽量用最小例子训练概念，例如二维向量、$`2\times2`$ 矩阵、两个结果的量子系统。
